<?php
    ...
    $sql = "SELECT commande.idCommande,users.nom,users.prenom,commande.dateCommande,commande.telephone,commande.adresse,commande.prixUT FROM commande,users WHERE commande.etat_commande='en attente' AND commande.is_standard=1 AND commande.idUser=users.idUser ORDER BY commande.dateCommande ASC";
